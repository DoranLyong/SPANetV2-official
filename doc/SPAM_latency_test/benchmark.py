...
Modified from https://github.com/huggingface/pytorch-image-models/blob/59b3d86c1d69fe85ccb5bbdb2f1711eadae6e4a7/benchmark.py
"""
import argparse
import csv
import json
